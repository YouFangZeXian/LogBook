...
export function ContributionPanel({
  ...
  const submit = () => {
    if (!getCurrentLogbookUser()) {
      requestLogbookLogin("想把你的发现交给船舱吗？");
      return;
    }
  ...
  return (
    <section className="surface p-6 md:p-8">
      ...
      {/* ── Success Feedback ── */}
      {success ? (
        <div className="mt-5 rounded-[16px] border border-success/20 bg-success-soft p-5">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-muted">
                  感谢你的补给。你的发现可能会帮下一位船员少绕一段远路。
                </p>
              </div>
              <div className="grid gap-2 sm:grid-cols-3 text-sm leading-6">
                <div className="rounded-[10px] border border-border bg-white p-3">
                  <p className="font-medium text-foreground">加入 QQ 群</p>
