  ...
  return (
    <div className="page-shell space-y-8 py-10 md:py-14">
      <section className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="rounded-[1.05rem] border border-line bg-background/62 p-6 md:p-8">
          <Sparkle size={22} className="text-sky-700" />
        ...
        {discoveries.map((item) => {
          ...
          return (
            <Link
              key={item.title}
              href={item.href}
              className="rounded-[1rem] border border-line bg-white/62 p-5 transition-colors hover:border-foreground"
            >
